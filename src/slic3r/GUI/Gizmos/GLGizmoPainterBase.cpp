...
void TriangleSelectorPatch::update_triangles_per_type()
{
    ...
    bool using_wireframe = false;//(m_need_wireframe && wxGetApp().plater()->is_wireframe_enabled() && wxGetApp().plater()->is_show_wireframe()) ? true : false;
