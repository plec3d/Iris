...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], float inp[12],  ImGuiColorEditFlags flags = 0, const char* current_label = NULL, const char* original_label = NULL);
    IMGUI_API bool          ColorPicker3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], float inp[12],  ImGuiColorEditFlags flags = 0, const float* ref_col = NULL, const char* current_label = NULL, const char* original_label = NULL);
