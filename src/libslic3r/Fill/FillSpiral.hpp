#ifndef slic3r_FillSpiral_hpp_
#define slic3r_FillSpiral_hpp_
...
class FillSpiral : public Fill
{
public:
    ~FillSpiral() override = default;
	
protected:
     Fill* clone() const override { return new FillSpiral(*this); };
